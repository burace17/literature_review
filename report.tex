...
In the literature, several extensions to DTLS and HIP were proposed. One of the extensions, HIP-PSK, provided a substantial 
...
proposed. In the U.S., the FTC has only recommended general cyber security legislation. 
\end{flushleft}
\end{abstract}
...
The European Commission has been drafting new legislation to address the security of the Internet of Things. (\cite{Stupp}). 
